...
import com.example.lavozdelosnios.databinding.ActivityYoCuidoMiCuerpoParte2Binding

class Yo_cuido_mi_cuerpo_parte2 : AppCompatActivity() {

    private lateinit var binding: ActivityYoCuidoMiCuerpoParte2Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_yo_cuido_mi_cuerpo_parte2)
        binding = ActivityYoCuidoMiCuerpoParte2Binding.inflate(layoutInflater)
                    ...
                    MotionEvent.ACTION_UP -> {
                        ...
                        if (Rect.intersects(ballRect, imageView3Rect)) {
                            ...
                            if (correctPosition != null) {
                                ...
                                AlertDialog.Builder(this@Yo_cuido_mi_cuerpo_parte2)
                            ...
                            imageView3.animate().scaleX(1.2f).scaleY(1.2f).setDuration(300)
                                .withEndAction {
